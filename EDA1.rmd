...
for (j in 1:length(index_safe_beers_IBU)) {
  ...
  all_beer_ds[index_safe_beers_IBU[j], "IBU"] = style_IBU_cnt[style_IBU_cnt$Style == all_beer_ds[index_safe_beers_IBU[j], "Style"], "IBU"](0)
...
# MERGE median values
all_beer_ds <- merge(all_beer_ds, plt_ds, by = "State", all.x = T )
